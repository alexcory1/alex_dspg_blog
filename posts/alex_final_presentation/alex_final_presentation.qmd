...
Metro Population is a function that determines the population of the city that
...
Cities Population is a function that finds all the nearby cities and finds the
...
closest store. This method ignores the radius that the other store would
have. A more elegant solution to this would be Voronoi polygons,
Reilly's law of Retail Gravitation, or Huff's Model.
